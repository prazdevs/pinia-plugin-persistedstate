...
Are you using [Pinia](https://pinia.vuejs.org/) with [Nuxt](https://nuxt.com/) ([Pinia in Nuxt](https://pinia.vuejs.org/ssr/nuxt.html)) and want to add the persisted state plugin? There is a [plugin for that](https://prazdevs.github.io/pinia-plugin-persistedstate/frameworks/nuxt-3.html).
